...
//   }
    ...
    return (
        <div>
            ...
            <button className="bg-logo-bg text-black font-bold  px-1 py-1 rounded-md mb-1 ml-1 mt-2 -m-3 text-sm"
              type="button" onClick={handleManagerView}>{showRegistrations ? "Hide Registrations" : "View Registrations"}</button>
              {showRegistrations && (
                ...
                <tbody>
                    {registrations.map(registration => (
                        <tr key={registration.id}>
                            <td className="border border-gray-300 px-4 py-2">{registration.student_id}</td>
                            <td className="border border-gray-300 px-4 py-2">{registration.role_id}</td>
